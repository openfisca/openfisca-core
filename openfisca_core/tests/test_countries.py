...
tax_benefit_system.add_variables_from_module(TEST_DIRECTORY + '/dummy_country.py')

# We cannot put the variable declarations in this file, there would be an import loop
tax_benefit_system.add_variables_from_module(TEST_DIRECTORY + '/variables_test_countries.py')
