...
class SimulationBuilder:
    ...
    def set_default_period(self, period_str):
        if period_str:
            self.default_period = str(periods.build(period_str))
    ...
    def add_variable_value(self, entity, variable, instance_index, instance_id, period_str, value):
        ...
        self.input_buffer[variable.name][str(periods.build(period_str))] = array
    ...
    def finalize_variables_init(self, population):
        ...
        for variable_name in self.input_buffer.keys():
            ...
            unsorted_periods = [periods.build(period_str) for period_str in self.input_buffer[variable_name].keys()]
