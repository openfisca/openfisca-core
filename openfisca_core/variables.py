...
class Variable(object):
    ...
    def __init__(self, baseline_variable=None):
        ...
        self.value_type = self.set(
            attr, "value_type", required=True, allowed_values=VALUE_TYPES.keys()
        )
        ...
        self.definition_period = self.set(
            ...
            "definition_period",
            required=True,
            allowed_values=(DAY, MONTH, YEAR, ETERNITY),
        )
...
def get_annualized_variable(
    variable: Variable, annualization_period: Optional[periods.Period] = None
) -> Variable:
    """
