...
formatted_zone = numpy.concat('plafond_pour_accession_a_la_propriete_zone_', zone_apl)  # zone_apl returns 1, 2 or 3 but the parameters have a long name
...
def formula_without():
    ...
    return (zone_apl == 1) * (
        z1.personne_isolee_sans_enfant * numpy.logical_not(couple) * (al_nb_pac == 0)
        ...
        z2.personne_isolee_sans_enfant * numpy.logical_not(couple) * (al_nb_pac == 0)
        ...
        z3.personne_isolee_sans_enfant * numpy.logical_not(couple) * (al_nb_pac == 0)
