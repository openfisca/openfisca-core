...
def formula_with():
    ...
    result = (
        plafonds.personne_isolee_sans_enfant
        * numpy.logical_not(couple)
        * (al_nb_pac == 0)
...
def formula_without():
    ...
    return (
        (zone_apl == 1)
        * (
            z1.personne_isolee_sans_enfant
            * numpy.logical_not(couple)
            * (al_nb_pac == 0)
        ...
        + (zone_apl == 2)
        * (
            z2.personne_isolee_sans_enfant
            * numpy.logical_not(couple)
            * (al_nb_pac == 0)
        ...
        + (zone_apl == 3)
        * (
            z3.personne_isolee_sans_enfant
            * numpy.logical_not(couple)
            * (al_nb_pac == 0)
