...
def main():
    ...
    check_revenu_disponible(
        2010, "97123", np.array([1130.0, 1130.0, 25130.0, 1130.0, 50330.0, 1130.0])
    )
    check_revenu_disponible(
        2011, "98456", np.array([2330.0, 2330.0, 25130.0, 2330.0, 50330.0, 2330.0])
    )
    check_revenu_disponible(
        2012, "98456", np.array([2330.0, 2330.0, 25130.0, 2330.0, 50330.0, 2330.0])
    )
    check_revenu_disponible(
        2013, "98456", np.array([3530.0, 3530.0, 25130.0, 3530.0, 50330.0, 3530.0])
    )
