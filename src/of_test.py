...
from spyderlib.utils import encoding, programs #, vcs, programs
#try:
...
# from src.core.plugins.configdialog import 
from src.core.configdialog import (ConfigDialog, MainConfigPage,
...
#                         (self.inspector, self.console, Qt.Vertical),
                         (self.distribution, self.distribution, Qt.Horizontal)
                         )
...
#                    plugin.dockwidget.close()
            for plugin in (self.distribution,):
                if plugin is not None:
