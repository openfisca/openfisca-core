...
from src.qt.QtGui import (QTreeView, QTableView, QApplication, QWidget, QLabel, QHBoxLayout, QComboBox, QSpinBox, QDoubleSpinBox)
from src.qt.QtCore import Qt, SIGNAL, QString, QAbstractTableModel
...
from src.qt.QtGui import (QDialog, QVBoxLayout)
