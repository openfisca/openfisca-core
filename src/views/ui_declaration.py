...
#
# Created: Tue Feb 21 11:40:25 2012
...
""))
        ...
        self.navigationView = QtGui.QListView(Declaration)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.navigationView.sizePolicy().hasHeightForWidth())
        self.navigationView.setSizePolicy(sizePolicy)
        self.navigationView.setMinimumSize(QtCore.QSize(200, 200))
        self.navigationView.setMaximumSize(QtCore.QSize(200, 200))
        self.navigationView.setObjectName(_fromUtf8("navigationView"))
        self.verticalLayout.addWidget(self.navigationView)
        ...
        self.prevButton.setText(QtGui.QApplication.translate("Declaration", "...", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.nextButton.setText(QtGui.QApplication.translate("Declaration", "...", None, QtGui.QApplication.UnicodeUTF8))
