...
def _rev_sal(sal, cho):
    '''
    Revenu imposé comme des salaires (salaires)
    'ind'
    '''
    return sal + cho
...
def _pen_net(rev_pen, rev_pen_etr, _P):
    '''
    Pensions et rentes viagères après abattements
    'ind'
    '''
    P = _P.ir.tspr
    return rev_pen*(1-P.abat_pen) + rev_pen_etr(1-P.abat_pen_etr)
...
def _fon_bat_net(fon_bat, _P):
    '''
    Revenus fonciers net des propriétés bâties
    '''
...
def _retr():
    '''
    Revenus provenant de l'étranger s'ils n'ont pas supporté l'impôt dans le pays de la source
    '''


def _revimp():
    '''
    Revenu net soumis à l'impôt oaprès déduction des dépenses et charges professionnelles et des revenus non soumis à l'impôt
    '''
...
#Certains revenus sont exonérés pour encourager l'épargne ou l'investissement tels que : 
...
#   
#- la plus-value provenant de la levée par les salariés de l'option de souscription au capital des sociétés exerçant essentiellement dans le secteur de services informatiques, d'ingénierie informatique et de services connexes et dans le secteur de la technologie de communication et de l’information et des nouvelles technologies ainsi que les société cotées en bourse et ce sous réserve de certaines conditions,
#-    la plus value provenant de la transmission des entreprises pour départ à la retraite du dirigeant ou pour incapacité de gestion ou provenant de la transmission des entreprises en difficultés économiques, et ce, sous réserve de certaines conditions, 
#   - Les intérêts des comptes d’épargne pour l’investissement dans la limite de 2.000D par an, 
#   - Les rentes viagères servies en exécution des contrats d’assurance-vie.




#Sont admises en déduction du revenu global certaines déductions pour tenir compte des charges familiales ou pour encourager l'investissement dans certains secteurs. Il s’agit notamment : 
#   - Des arrérages des rentes payées à titre obligatoire et gratuit, 
#   - Des primes afférentes aux contrats d'assurance vie dans les limites fixées par la législation en vigueur, 
#   - Des intérêts des comptes spéciaux d'épargne ou des emprunts obligataires et ce dans des limites fixées par la législation en vigueur,
#   - Des montants déposés dans les comptes-épargne pour l’investissement et dans les comptes-épargne en actions dans la limite de 20.000D par an et sous réserve du minimum d’impôt, 
#   - Du remboursement des prêts universitaires en principal et en intérêts,
#   - Des revenus provenant de l'exportation totalement pendant 10 ans à partir de la première opération d'exportation pour les entreprises exerçant avant le 1er janvier 2011 et les entreprises ayant obtenu une attestation de dépôt de déclaration d'investissement avant le 1er janvier 2011 et qui entrent en activité effective et réalisent la 1ère opération d'exportation au cours de l'exercice 2011,
#   - Des revenus provenant de la location d'immeubles ou de la restauration au profit des étudiants, des élèves et des apprenants dans les centres de formation profesionnelle de base pendant 10 ans, 
#   - Des revenus provenant du courtage international dans la limite de 50% pendant 10 ans à partir de la première opération de courtage international;
#   - Des revenus réinvestis dans la souscription au capital des entreprises conformément aux conditions prévues par la législation relative aux avantages fiscaux, 
#   - Des revenus réinvestis dans les projets d’hébergement et de restauration au profit des étudiants, des élèves et des apprenants dans les centres de formation professionnelle de base sous réserve du minimum d’impôt, 
#   - Des déductions au titre de la situation des charges de famille (chef de famille, enfants à charge, parents à charge).
