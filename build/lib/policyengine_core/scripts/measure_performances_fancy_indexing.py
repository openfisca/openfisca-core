...
N = 200000
al_plaf_acc = tbs.get_parameters_at_instant(
    "2015-01-01"
).prestations.al_plaf_acc
...
def formula_without():
    ...
    return (
        ...
        * (
            ...
            + z1.menage_ou_isole_par_enfant_en_plus
            * (al_nb_pac > 5)
            * (al_nb_pac - 5)
        )
        + (zone_apl == 2)
        * (
            ...
            + z2.menage_ou_isole_par_enfant_en_plus
            * (al_nb_pac > 5)
            * (al_nb_pac - 5)
        )
        + (zone_apl == 3)
        * (
            ...
            + z3.menage_ou_isole_par_enfant_en_plus
            * (al_nb_pac > 5)
            * (al_nb_pac - 5)
        )
    )
...
if __name__ == "__main__":
    ...
    print(
        "Computing with dynamic legislation computing took {}".format(
            time_with
        )
    )
    print(
        "Computing without dynamic legislation computing took {}".format(
            time_without
        )
    )
