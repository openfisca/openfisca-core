...
def test_return_code(extended_subject) -> None:
    parameters_response = extended_subject.get("/parameters")
    assert parameters_response.status_code == client.OK


def test_return_code_existing_parameter(extended_subject) -> None:
...
def test_return_code_existing_variable(extended_subject) -> None:
