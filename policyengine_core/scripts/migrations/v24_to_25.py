    ...
    def convert_inputs(self, inputs):
        ...
        for entity_plural, entities_description in inputs.items():
            ...
            if not entity.is_person and len(entities_description) == 1:
                ...
                continue
            results[entity_plural] = self.convert_entities(
                entity, entities_description
            )
    ...
    def convert_entities(self, entity, entities_description):
        return {
            entity_description.get(
                "id", "{}_{}".format(entity.key, index)
            ): remove_id(entity_description)
            ...
            if len(persons) == 1:
                ...
                inputs[entity.plural] = {
                    "{}_{}".format(entity.key, index): {
                        entity.roles[0].plural
                        or entity.roles[0].key: [person_id]
                    }
