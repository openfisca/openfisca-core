...
from policyengine_core import periods, simulations
...
class city_code(Variable):
    ...
    label = (
        """Code INSEE "city_code" de la commune de résidence de la famille"""
    )
...
def main():
    ...
    check_revenu_disponible(
        2009, "75101", np.array([0, 0, 25200, 0, 50400, 0])
    )
    check_revenu_disponible(
        2010, "75101", np.array([1200, 1200, 25200, 1200, 50400, 1200])
    )
    check_revenu_disponible(
        2011, "75101", np.array([2400, 2400, 25200, 2400, 50400, 2400])
    )
    check_revenu_disponible(
        2012, "75101", np.array([2400, 2400, 25200, 2400, 50400, 2400])
    )
    check_revenu_disponible(
        2013, "75101", np.array([3600, 3600, 25200, 3600, 50400, 3600])
    )

    check_revenu_disponible(
        2009, "97123", np.array([-70.0, -70.0, 25130.0, -70.0, 50330.0, -70.0])
    )
    check_revenu_disponible(
        2010,
        "97123",
        np.array([1130.0, 1130.0, 25130.0, 1130.0, 50330.0, 1130.0]),
    )
    check_revenu_disponible(
        2011,
        "98456",
        np.array([2330.0, 2330.0, 25130.0, 2330.0, 50330.0, 2330.0]),
    )
    check_revenu_disponible(
        2012,
        "98456",
    ...
    check_revenu_disponible(
        2013,
        "98456",
        np.array([3530.0, 3530.0, 25130.0, 3530.0, 50330.0, 3530.0]),
    )
