...
Note:
    How imports are being used today::
        ...
        from policyengine_core.commons import *  # Bad
        from policyengine_core.commons.formulas import switch  # Bad
        from policyengine_core.commons.decorators import deprecated  # Bad
    ...
    How they could be used in a future release:
        ...
        from policyengine_core.commons import deprecated
